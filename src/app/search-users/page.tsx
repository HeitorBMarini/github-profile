    ...
    <div className="flex flex-col items-center w-full">
      ...
      <div className="w-full flex justify-center mt-4 px-4 md:px-0">
        <input
          ...
          className="text-black p-2 w-full md:w-80 rounded-lg border-2 border-gray-300"
        />
      ...
      {loading ? (
        ...
        <div className="flex flex-col md:flex-row justify-between w-full mt-8 px-4 md:px-0">
          <UserProfile profile={user}/>
          <div className="flex flex-col gap-4 w-full max-w-4xl ml-auto">
            <div className="flex flex-col md:grid md:grid-cols-2 gap-4 place-items-center">
              {repos.map((repo) => (
